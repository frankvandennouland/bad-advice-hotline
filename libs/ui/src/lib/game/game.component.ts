...
//                   >Score: {{ advice.ai_score || 'Not scored' }}</span
//                 >
//                 <button
//                   *ngIf="store.isGameActive()"
...
//
//     if (this.adviceText.trim() && currentGame && currentUser) {
//       this.store
//         .submitAdvice({
//           game_id: currentGame.id,
//           user_id: currentUser.id,
//           content: this.adviceText.trim(),
//         })
//         .subscribe({
//           next: () => {
//             this.adviceText = '';
...
//       this.store.scoreAdvice(this.store.currentGame()!.id, adviceId).subscribe({
//         error: (error) => {
